...
def plot_folium_heatmap(df, file_name, map_style, color_scale, radius=15, blur=20):
    ...
    map_data = st_folium(m, width=1500, height=600, key=f"folium_heatmap_{file_name}")
    ...
    if clicked_info:
        map_data = st_folium(m, width=1500, height=600, key=f"folium_heatmap_{file_name}_marker")
